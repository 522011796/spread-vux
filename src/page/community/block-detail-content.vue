...
<script>
  ...
  export default {
    ...
    name: 'detail',
    created(){
      console.log(this.$route.query.backFirstName);
      this.back = this.$route.query.back;
      this.backFirstName = this.$route.query.backFirstName;
      this.blockName = this.$route.query.blockName;
    },
    methods:{
      backUrl(){
        this.$router.push({path: this.back, query: {backFirstName:this.backFirstName,blockName:this.blockName}});
      }
    }
  }
</script>
